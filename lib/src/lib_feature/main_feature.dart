...
class MainFeatureBased extends StatefulWidget {
  const MainFeatureBased({super.key});

  @override
  State<MainFeatureBased> createState() => _MainFeatureBasedState();
}

class _MainFeatureBasedState extends State<MainFeatureBased> {
  int currentIndex = 0;
